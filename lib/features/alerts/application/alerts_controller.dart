...
class AdaptiveAlertsFeedService implements AlertsFeedService {
  ...
  static const String _defaultWsPath = '/api/mobile/alerts/ws';
  static const String _bootstrapUrl = String.fromEnvironment(
    'ALERTS_BOOTSTRAP_URL',
    defaultValue: '/api/mobile/alerts',
  );
          ...
          .post<Object>(
            ...
            options: Options(
              headers: <String, Object?>{
                'Idempotency-Key':
                    'mobile-replan-${sourceAlertId ?? 'manual'}-$trigger',
              },
            ),
          );
